...
public class ChangeIconCommandHandler : IRequestHandler<ChangeIconCommand, Result<bool>>
{
  ...
  public async Task<Result<bool>> Handle(ChangeIconCommand command, CancellationToken cancellationToken)
  {
