...
public class MakePaymentCommandHandler : IRequestHandler<MakePaymentCommand, Result<bool>>
{
  ...
  public async Task<Result<bool>> Handle(MakePaymentCommand command, CancellationToken cancellationToken)
  {
