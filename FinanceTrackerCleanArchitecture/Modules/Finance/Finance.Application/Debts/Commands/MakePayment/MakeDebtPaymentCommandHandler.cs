...
public class MakeDebtPaymentCommandHandler : IRequestHandler<MakeDebtPaymentCommand, Result<bool>>
{
  ...
  public async Task<Result<bool>> Handle(MakeDebtPaymentCommand command, CancellationToken cancellationToken)
  {
